// src/main/java/controller/HomePageController.java
package controller;
...
public class HomePageController {
    ...
    public void runHomePage() {
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            HomePageService homePageService = new HomePageService(connection);
            while (running) {
                    ...
                    case "2":
                        try {
                            ...
                            if (loggedInUser.getUserRole() == UserRole.ADMIN) {
                                adminPageController.runAdminPage(loggedInUser.getEmail());
